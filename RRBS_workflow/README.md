Please see the [COHCAP manual](https://bioconductor.org/packages/release/bioc/vignettes/COHCAP/inst/doc/COHCAP.pdf) for acknowledgements.  The most relevant part is probably "*we would like to acknowledge ... Yapeng Su (Caltech) for having a project to test application of COHCAP to RRBSdata*."
